  ...
  return (
    <>
      ...
      <section className="flex my-4 px-4 gap-2">
        <div className="w-1/3 h-[250px] bg-gray-700 rounded backdrop-blur-xxl bg-white/50 justify-center items-center"><MoviesOverTime /></div>
        ...
        <div className="w-1/3 h-[250px] bg-gray-700 rounded backdrop-blur-xxl bg-white/50 justify-center items-center"><Ratings /></div>
      </section>
    </>
  );
};
